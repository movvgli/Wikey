...
Wikey 1.1.0부터는 하루에 한 번 새 버전을 확인합니다. **Wikey → 업데이트 확인…** 또는 **설정 → 업데이트**에서 직접 확인할 수도 있습니다. 1.0.0 사용자는 자동 업데이트 기능이 없으므로 1.1.0을 한 번 직접 설치해야 합니다.
