    ...
    <div className="site-shell" id="top">
      ...
      <main id="main">
        ...
        <section className="privacy-section" id="privacy" aria-labelledby="privacy-title">
          ...
          <div className="privacy-copy"><p>워크플로, 템플릿, 앱별 단축키와 레이아웃은 Mac에 저장됩니다. Wikey 계정이나 클라우드에 업로드하지 않습니다.</p><p>이 사이트는 사용자의 실제 앱 목록이나 개인 워크플로를 읽지 않습니다. 화면 속 내용은 모두 설명용 예시예요.</p><p className="small-copy">자동 업데이트를 확인할 때는 GitHub에 연결합니다. 직접 연 웹사이트나 붙여넣은 외부 앱에서의 데이터 처리는 해당 서비스의 정책을 따릅니다.</p><a className="text-link" href={`${GITHUB_URL}/blob/main/docs/PRIVACY.md`}>개인정보 안내 읽기 <ArrowRight size={16} /></a></div>
        </section>
